  ...
  return (
    <div className="wow fadeInUp pricing-item-border relative z-20 overflow-hidden rounded-3xl bg-dark px-8 pb-10 pt-12.5 xl:px-10">
      ...
      <h3 className="mb-5.5 text-heading-6 font-semibold text-white">
        ...
        {price.nickname === "Medium" && "Standard"}
        {price.nickname === "Large" && "Premium"}
      </h3>
      ...
      {price.nickname === "Small" && (
        <ul className="flex flex-col gap-4">
          <OfferItem text="Access to basic features" />
          <OfferItem text="Milestone tracking" />
          <OfferItem text="Shared goals & event logging" />
          <OfferItem text="Basic customer support" />
        </ul>
      )}
      ...
      {price.nickname === "Medium" && (
        <ul className="flex flex-col gap-4">
          ...
          <OfferItem text="VeeSell Verified background checks" />
      ...
      {price.nickname === "Large" && (
        <ul className="flex flex-col gap-4">
          <OfferItem text="All Standard features" />
          <OfferItem text="Escrow account with shared savings" />
          <OfferItem text="Personalized milestone reminders" />
          <OfferItem text="Exclusive partner rewards" />
        </ul>
      )}
      ...
      <p className="mt-4 text-center text-sm">No extra hidden charges</p>
