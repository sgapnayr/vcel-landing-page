                  ...
                  <div className="relative z-20 flex items-center justify-between">
                    <div className="w-full max-w-[477px]">
                      ...
                      <p className="mb-10 font-medium">
                        Easily set up a shared escrow account with your partner
                        to invest in relationship goals like vacations, wedding
                ...
                <div className="box-hover box-hover-small relative overflow-hidden rounded-3xl px-11 pb-14 pt-12.5">
                  <div className="relative z-20">
                    ...
                    <p className="font-medium">
                      Track key milestones in your relationship, including
                      anniversaries, shared vacations, and important events.
                    </p>
                  </div>
              ...
              <div className="features-box-border relative rounded-3xl">
                <div className="box-hover box-hover-small relative overflow-hidden rounded-3xl px-11 pb-14 pt-12.5">
                  <div className="relative z-20">
                    ...
                    <p className="font-medium">
                      Ensure safety and trust in your relationship with our
                      discreet verification feature.
                    </p>
                  </div>
